...
public class MemoryManipulation
{
	...
	// get process id using getProcessID("process name")
	// read memory returns Memory object
	// write memory using byte array
	...
	public static Pointer openProcessId(int pid)
	{
		return openProcess(PROCESS_VM_READ | PROCESS_VM_WRITE | PROCESS_VM_OPERATION, pid);
	}

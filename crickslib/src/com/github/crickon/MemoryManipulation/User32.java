...
public interface User32 extends W32APIOptions
{
	...
	boolean GetLayeredWindowAttributes(Pointer hwnd, IntByReference pcrKey, ByteByReference pbAlpha,
	...
	boolean UpdateLayeredWindow(Pointer hwnd, Pointer hdcDst, POINT pptDst, SIZE psize, Pointer hdcSrc, POINT pptSrc,
			int crKey, BLENDFUNCTION pblend, int dwFlags);
